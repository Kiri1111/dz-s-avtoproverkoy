...
function Clock() {
    ...
    // const stringTime = `${date.getHours().toString()}:${date.getMinutes().toString()}:${date.getSeconds().toString()}` // часы24:минуты:секунды (01:02:03)/(23:02:03)/(24:00:00)/(00:00:01) // пишут студенты
    ...
    // const stringDate = date.toLocaleString('en-us', {month: 'long'}) || <br/> // день.месяц.год (01.02.2022) // пишут студенты, варианты 01.02.0123/01.02.-123/01.02.12345 не рассматриваем
    ...
    // const stringMonth = date.toLocaleDateString() || <br/> // пишут студенты
